...
Meteor.startup(function () {
	if(Categories.find({}).count()<=0){
		...
		// Cours de Musique
		Categories.insert({code: 'learn-music', ancestors:[], root:true, level:0, name:'Cours de Musique', order:101});
		...
		// Education
		Categories.insert({code: 'learn-educ', ancestors:[], root:true, level:0, name:'Matières Scolaire', order:200});
		...
		// Cours de Cuisine
		Categories.insert({code: 'learn-cook', ancestors:[], root:true, level:0, name:'Cuisine', order:300});
		...
		// Cours de Sport
		Categories.insert({code: 'learn-sport', ancestors:[], root:true, level:0, name:'Sport', order:400});
		...
		Categories.insert({code: 'brico', ancestors:[], root:true, level:0, name:'Bricolage, Maison, Travaux & Jardins', order:500});
		...
		Categories.insert({code: 'brico-grdn-deco', ancestors:['brico'], name:'Jardin - Aménagement & décoration', order:551});
