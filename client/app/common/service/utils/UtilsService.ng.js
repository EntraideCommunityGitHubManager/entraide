angular.module("entraide").factory("UtilsService", function($q, $http){
        ...
        fileUtils:{
                ...
                downloadExcelFile: function(configParam){
                    ...
                    $http(config).success(function(data) {
                        ...
                        UtilsService.fileUtils.downloadFile(window.document, config.fileName, data, UtilsService.fileUtils.type[config.type]);
                ...
                downloadFile: function (pDocument, fileName, data, strMimeType) {
                    ...
                    if (UtilsService.navigatorUtils.isOldIE()) {
